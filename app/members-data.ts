// Auto-generated from uploaded DOCX files
export type Member = {
  name: string;
  title?: string;
  email?: string[];
...
Atomically Thin Antimony-Doped Indium Oxide Nanosheets for Optoelectronics. Adv. Optical Mater. 2022, 10, 2200925.
...
– ORCiD: orcid.org/0009-0005-6429-7733`
  },
  {
    ...
    email: [],
    avatar: "namuersaihan-namuersaihan.jpeg",
...
2017-2019 Master of Engineering, Harbin Institute of Technology, China
2013-2017. Bachelor of Engineering,  China University of Geoscience (Beijing), China
Research Interest
...
Photocatalytic styrene polymerisation with liquid metal films`
  },
  {
    ...
    email: [],
    avatar: "zilong-introduction.jpeg",
    bio: `Zilong Wang
